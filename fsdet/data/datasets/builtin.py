...
def register_all_pascal_voc(root="datasets"):
    SPLITS = [
        ...
        ("aquarium_2007_test", "aquarium2007", "test"),
    ]
    ...
    METASPLITS = [
        ...
        ("aquarium_2007_trainval_all1", "aquarium2007", "trainval", "base_novel_1", 1),
        ("aquarium_2007_trainval_all2", "aquarium2007", "trainval", "base_novel_2", 2),
        ("aquarium_2007_trainval_all3", "aquarium2007", "trainval", "base_novel_3", 3),
        ("aquarium_2007_test_base1", "aquarium2007", "test", "base1", 1),
        ("aquarium_2007_test_base2", "aquarium2007", "test", "base2", 2),
        ("aquarium_2007_test_base3", "aquarium2007", "test", "base3", 3),
        ("aquarium_2007_test_novel1", "aquarium2007", "test", "novel1", 1),
        ("aquarium_2007_test_novel2", "aquarium2007", "test", "novel2", 2),
        ("aquarium_2007_test_novel3", "aquarium2007", "test", "novel3", 3),
