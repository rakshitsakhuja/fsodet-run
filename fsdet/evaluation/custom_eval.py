...
class CustomPascalVOCDetectionEvaluator(DatasetEvaluator):
    """
    Evaluate Custom Pascal VOC AP replicated from Original one.
    """
    ...
    def evaluate(self):
        ...
        self._logger.info(
            ...
            "Note that results do not use the official Matlab API.".format(
                ...
                self._dataset_name, 2012
            )
        )

        with tempfile.TemporaryDirectory(prefix="custom_eval_") as dirname:
