...
inline int deform_conv_forward(
  ...
  if (input.is_cuda()) {
#ifdef WITH_CUDA
    AT_CHECK(weight.is_cuda(), "weight tensor is not on GPU!");
    AT_CHECK(offset.is_cuda(), "offset tensor is not on GPU!");
...
#ifdef WITH_CUDA
    AT_CHECK(input.is_cuda(), "input tensor is not on GPU!");
    AT_CHECK(weight.is_cuda(), "weight tensor is not on GPU!");
    AT_CHECK(offset.is_cuda(), "offset tensor is not on GPU!");
...
#ifdef WITH_CUDA
    AT_CHECK(weight.is_cuda(), "weight tensor is not on GPU!");
    AT_CHECK(bias.is_cuda(), "bias tensor is not on GPU!");
    AT_CHECK(offset.is_cuda(), "offset tensor is not on GPU!");
